import"./style-v06b81ne.js";import{p as u,g as L,a as s,c as n}from"./header-qYaCn0IU.js";/* empty css               */import{c as y,b as I,S as x,N as B,P as S,A as k}from"./autoplay-kvZURvwd.js";import{c as m,i as D}from"./checkLogin-VMqPfWLq.js";import{g as o,s as b,a as A,d as N}from"./setDefaultData-8dNE6q3B.js";m();const T=await u.collection("products").getList(1,15),U=L(".item_list_container");y(U,T.items);const g=s(".cart_button"),f=s(".icon_wrapper");function P(t){const r=t.currentTarget.previousElementSibling.firstElementChild,c=r.firstElementChild,l=r.lastElementChild.children[1];function d(){return`
