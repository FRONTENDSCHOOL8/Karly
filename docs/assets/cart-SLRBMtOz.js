import"./style-v06b81ne.js";import{p as y,a as u,g as S}from"./header-qYaCn0IU.js";import"./footer-GuUMSODD.js";import{c as M,i as v,g as A,a}from"./checkLogin-VMqPfWLq.js";import{s as T}from"./setDocumentTitle-_OwlDZqT.js";/* empty css               */import"./setDefaultData-8dNE6q3B.js";T("칼리 | 장바구니");M();const H=await y.collection("products").getFullList({filter:'package_type~"냉장"'}),N=await y.collection("products").getFullList({filter:'package_type~"냉동"'}),$=await y.collection("products").getFullList({filter:'package_type~"상온"'});H.forEach(e=>{v(".cart_content_list_1",k(e))});N.forEach(e=>{v(".cart_content_list_2",k(e))});$.forEach(e=>{v(".cart_content_list_3",k(e))});function k(e){return`
      <li>
