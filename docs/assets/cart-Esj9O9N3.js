import"./style-v06b81ne.js";import{t as h,g as o,a as v}from"./header-60uMwEkC.js";import"./footer-GuUMSODD.js";import{p as u}from"./pocketbase-mqgmocw_.js";import{i as p,c as d,g}from"./getPbImageURL-VQZ22oC_.js";import{s as k,g as y}from"./storage-4MU69DjX.js";import{s as E}from"./setDocumentTitle-_OwlDZqT.js";import{a as L}from"./setDefaultData-b6PVXYnJ.js";/* empty css               */E("칼리 | 장바구니");localStorage.getItem("auth")||k("auth",L);async function q(){const a=await h.get("https://square-zebra.pockethost.io/api/collections/cart/records");let{cartData1:n,cartData2:c,cartData3:t}=a.data.items;const{isAuth:e,user:s}=await y("auth");n=await u.collection("cart").getFullList({filter:'package_type~"냉장"'}),c=await u.collection("cart").getFullList({filter:'package_type~"냉동"'}),t=await u.collection("cart").getFullList({filter:'package_type~"상온"'});function l(r,i){return`
      <li>
