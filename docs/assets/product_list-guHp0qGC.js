import"./style-v06b81ne.js";import{a as m,g as e,c as i}from"./header-MICfn_ID.js";/* empty css               */import{i as u}from"./getPbImageURL-Q86jnK4B.js";import{c as p}from"./itemList-RegNhfZf.js";import{p as C}from"./pocketbase-mqgmocw_.js";const h=await C.collection("products").getList(1,15),_=m(".item_list_container");p(_,h.items);const g=e(".cart_button"),f=e(".icon_wrapper");function v(r){const s=r.currentTarget.parentElement.firstElementChild.firstElementChild,c=s.firstElementChild,a=s.lastElementChild.children[1];function o(){return`
